...
create view [dbo].[From_V_Customer_TC]
as
select dln.DocEntry,
dln.CardName,
dln.DocDate,
...
dn1.Quantity,
isnull(DN7.U_TCDT,dn1.U_TCDT) 'TEST DATE',
isnull(dn7.U_PRROFLOAD,dn1.U_Proofload) 'PROOF LOAD',
isnull(DN7.U_SWL,dn1.U_SWL) 'SWL',
'' 'DISTING MARK',
'' 'TYPE OF',
'' 'SERIAL NO',
dn7.U_LIfT 'LIFT',
...
--,IV1.Dscription //changes 16-05-2019
